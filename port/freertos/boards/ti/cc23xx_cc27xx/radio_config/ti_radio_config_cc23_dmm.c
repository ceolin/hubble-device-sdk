...
//  PHY definition file: ble_bt5_1m_2m_coded_cc23xx.json
// ****************************************************************
...
//  PHY definition file: ble_bt6_cs_hp_cc23xx.json
// ****************************************************************
...
static const uint32_t LRF_commonRegConfigBleCsHp[] =
{
    ...
    0x05F90001,                     //     LRFDMDM.DEMMISC2              LRFDMDM.DEMMISC1
    ...
    0x2FEF0025,                     //     RFE_COMMON_RAM.K3BL           RFE_COMMON_RAM.K2AL
    ...
    0x0005002E,                     //     RFE_COMMON_RAM.DCOSETTLE      RFE_COMMON_RAM.CHRGSETTLE
    0x0000FE00,                     //     RFE_COMMON_RAM.IFAMPRFLDODEFAULT RFE_COMMON_RAM.IFAMPRFLDOTX
    0x684C6001,                     //   RAM 32-bit region (start address = 0x684C, count = 2)
...
//  PHY definition file: ble_bt5_1m_2m_coded_generic_cc23xx.json
// ****************************************************************

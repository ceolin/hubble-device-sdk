...
RCL_CmdGenericTxTest rclPacketTxCmdGenericTxTest_ble_gen_0 = 
{
...
static const uint32_t LRF_subPhy1MbpsCodedRegConfigBleGen[] =
{
    ...
    (uint32_t) &LRF_swConfig1Mbps_ble_gen_0,//     LRF_swParam : swConfig
    (uint32_t) &LRF_txPowerLimitTable1Mbps_ble_gen_0,//     LRF_swParam : txPowerLimitTable
...
static const uint32_t LRF_subPhy2MbpsRegConfigBleGen[] =
{
    ...
    0x0000A001,                     //   Data structure 32-bit region (start byte position = 0, count = 2)
    (uint32_t) &LRF_swConfig2Mbps_ble_gen_0,//     LRF_swParam : swConfig
    (uint32_t) &LRF_txPowerLimitTable2Mbps_ble_gen_0,//     LRF_swParam : txPowerLimitTable
...
static const LRF_RegConfigList LRF_regConfigList_ble_gen_0 = {
    .numEntries = 9,
    .entries = {
...
const LRF_TxShape LRF_shapeBaseGfsk067_ble_gen_0 = {
    .scale = 0x0FDE2,
    .numCoeff = 0x0011,
...
// LRF_TxShape data structure
const LRF_TxShape LRF_shapeBaseGfsk05_ble_gen_0 = {
    .scale = 0x0F183,
    .numCoeff = 0x0014,
...
const LRF_SwConfig LRF_swConfig1Mbps_ble_gen_0 = {
    .rxIntFrequency = 1000000,
    .rxFrequencyOffset = 0,
    .txFrequencyOffset = 0,
    .modFrequencyDeviation = 0x0003D090,
    .txShape = &LRF_shapeBaseGfsk067_ble_gen_0,
    .bwIndex = 0x00,
    .bwIndexDither = 0x01
};

// LRF_SwConfig data structure
const LRF_SwConfig LRF_swConfig2Mbps_ble_gen_0 = {
    .rxIntFrequency = 850000,
    .rxFrequencyOffset = 0,
    .txFrequencyOffset = 0,
    .modFrequencyDeviation = 0x0007A120,
    .txShape = &LRF_shapeBaseGfsk05_ble_gen_0,
    .bwIndex = 0x01,
    .bwIndexDither = 0x01
};
...
const LRF_TxPowerLimitTable LRF_txPowerLimitTable1Mbps_ble_gen_0 = {
...
// LRF_TxPowerLimitTable data structure
const LRF_TxPowerLimitTable LRF_txPowerLimitTable2Mbps_ble_gen_0 = {
...
const LRF_Config LRF_config_ble_gen_0 = {
    ...
    .regConfigList = &LRF_regConfigList_ble_gen_0
};

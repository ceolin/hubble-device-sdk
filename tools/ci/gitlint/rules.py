...
"""
Additional Hubble Network specific rules for gitlint.
"""
...
# Signed-off-by rule. This implementation comes from Zephyr project.
class SignedOffBy(CommitRule):
    """
    This rule will enforce that each commit contains a "Signed-off-by" line.
    We keep things simple here and just check whether the commit body contains
    a line that starts with "Signed-off-by".
    """

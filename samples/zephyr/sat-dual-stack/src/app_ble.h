 ...
 *
 * Provides functions to initialize the BLE stack, provision the device over a
 * GATT service (time and satellite orbital parameters), and control the Hubble
 * terrestrial beacon advertising.
 */
 ...
 *
 * Enables the Bluetooth controller and host, and starts a connectable
 ...
 *
 * Halts beacon broadcasting and the payload refresh timer. Safe to call even
